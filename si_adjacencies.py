...
##        return self.edges[ix]
    ...
    def adjacent(self, land):
        ...
        yield from ((edge.neighbor.parent, j)
                    for edge in self.edges
                    for i, j in edge @ edge.neighbor if i == land)
...
GAME_BOARDS = {
    'A': ((1,6,8,7,5,4,3), (5,3,None,4,None,6,5,3),
               '2456,34,4,5,678,8,8'),
    'B': ((1,6,8,7,4,3), (6,3,None,4,None,6,4),
               '2456,34,4,57,67,78,8'),
    'C': ((1,6,8,7,4,3), (5,3,None,3,1,None,3),
               '256,345,4,57,67,78,8'),
    'D': ((1,8,7,6,4,3), (1,None,4,1,None,5,2),
               '2578,345,4,56,67,7,8'),
    'E': ((1,7,8,6,4,3), (4,2,None,2,None,6,3),
               '257,35,45,567,7,78,8'),
    'F': ((1,6,8,7,4,3), (4,1,None,3,None,5,2),
               '256,345,4,578,68,8,8'),
    'G': ((1,6,8,7,4,3), (4,2,None,3,None,6,4),
               '26,3456,4,57,678,8,8'),
    'H': ((1,8,7,4,3), (3,None,5,1,None,3),
...
if __name__ == "__main__":
    ...
    for i in range(1, 9):
        print(f'Neighbors of 🐑P{i}: {", ".join(f"{board.name}{number}" for board, number in p.adjacent(i))}')
